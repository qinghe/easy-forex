...
Taiwan = Exchange.create!(title: 'Exchange', seller_id: gerard.id, amount: 150, base_currency_id: usd.id, variable_currency_id: twd.id, city: 'Taïwan', meeting_date: "Mon, 21 Dec 2015")
Budapest = Exchange.create!(title: 'Exchange', seller_id: gerard.id, amount: 100, base_currency_id: huf.id, variable_currency_id: eur.id, city: 'Budapest', meeting_date: "Sat, 26 Dec 2015")
HongKong = Exchange.create!(title: 'Exchange', seller_id: edouard.id, amount: 200, base_currency_id: eur.id, variable_currency_id: hkd.id, city: 'Hong-Kong', meeting_date: "Thu, 31 Dec 2015")
Lille = Exchange.create!(title: 'Exchange', seller_id: jertrude.id, amount: 80, base_currency_id: gbp.id, variable_currency_id: eur.id, city: 'Lille', meeting_date: "Mon, 21 Dec 2015")
Barcelone = Exchange.create!(title: 'Exchange', seller_id: jertrude.id, amount: 90, base_currency_id: eur.id, variable_currency_id: mnt.id, city: 'Barcelone', meeting_date: "Wed, 23 Dec 2015")
Beijing = Exchange.create!(title: 'Exchange', seller_id: micheline.id, amount: 1000, base_currency_id: cny.id, variable_currency_id: usd.id, city: 'Beijing', meeting_date: "Tue, 29 Dec 2015")
Montevideo = Exchange.create!(title: 'Exchange', seller_id: helena.id, amount: 1200, base_currency_id: uyu.id, variable_currency_id: eur.id, city: 'Montevideo', meeting_date: "Mon, 21 Dec 2015")
LaPaz = Exchange.create!(title: 'Exchange', seller_id: cedric.id, amount: 120, base_currency_id: usd.id, variable_currency_id: bob.id, city: 'La paz', meeting_date: "Tue, 22 Dec 2015")
Quito = Exchange.create!(title: 'Exchange', seller_id: cedric.id, amount: 150, base_currency_id: usd.id, variable_currency_id: pen.id, city: 'Quito', meeting_date: "Mon, 04 Jan 2015")
Lille2 = Exchange.create!(title: 'Exchange', seller_id: margaux.id, amount: 150, base_currency_id: gbp.id, variable_currency_id: eur.id, city: 'Lille', meeting_date: "Sat, 02 Jan 2015")
Barcelone2 = Exchange.create!(title: 'Exchange', seller_id: margaux.id, amount: 50, base_currency_id: eur.id, variable_currency_id: cny.id, city: 'Barcelone', meeting_date: "Sat, 26 Dec 2015")
Taiwan2 = Exchange.create!(title: 'Exchange', seller_id: aymeric.id, amount: 1500, base_currency_id: twd.id, variable_currency_id: hkd.id, city: 'Taïwan', meeting_date: "Thu, 31 Dec 2015")
Lapaz2 = Exchange.create!(title: 'Exchange', seller_id: hortense.id, amount: 1000, base_currency_id: bob.id, variable_currency_id: eur.id, city: 'La Paz', meeting_date: "Mon, 04 Jan 2015")
HongKong2 = Exchange.create!(title: 'Exchange', seller_id: hortense.id, amount: 180, base_currency_id: hkd.id, variable_currency_id: usd.id, city: 'Hong-Kong', meeting_date: "Wed, 06 Jan 2015")
HongKong3 = Exchange.create!(title: 'Exchange', seller_id: hortense.id, amount: 300, base_currency_id: hkd.id, variable_currency_id: eur.id, city: 'Hong-Kong', meeting_date: "Tue, 29 Dec 2015")
Madrid = Exchange.create!(title: 'Exchange', seller_id: margaux.id, amount: 40, base_currency_id: eur.id, variable_currency_id: zar.id, city: 'Madrid', meeting_date: "Fri, 08 Jan 2015")
Lyon = Exchange.create!(title: 'Exchange', seller_id: pauline.id, amount: 1200, base_currency_id: vnd.id, variable_currency_id: eur.id, city: 'Lyon', meeting_date: "Tue, 22 Dec 2015")
Paris = Exchange.create!(title: 'Exchange', seller_id: pauline.id, amount: 300, base_currency_id: rub.id, variable_currency_id: eur.id, city: 'Paris', meeting_date: "Mon, 28 Dec 2015")
