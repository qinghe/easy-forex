...
Taiwan = Exchange.create!(title: 'Exchange Title', seller_id: gerard.id, amount: 150, base_currency_id: usd.id, variable_currency_id: twd.id, city: 'Taïwan', start_date: "Wed, 21 Dec 2016", end_date: "Fri, 23 Dec 2016")
Budapest = Exchange.create!(title: 'Exchange Title', seller_id: gerard.id, amount: 100, base_currency_id: huf.id, variable_currency_id: eur.id, city: 'Budapest', start_date: "Mon, 26 Dec 2016", end_date: "Thu, 29 Dec 2016")
HongKong = Exchange.create!(title: 'Exchange Title', seller_id: edouard.id, amount: 200, base_currency_id: eur.id, variable_currency_id: hkd.id, city: 'Hong-Kong', start_date: "Fri, 30 Dec 2016", end_date: "Sat, 31 Dec 2016")
Lille = Exchange.create!(title: 'Exchange Title', seller_id: jertrude.id, amount: 80, base_currency_id: gbp.id, variable_currency_id: eur.id, city: 'Lille', start_date: "Wed, 21 Dec 2016", end_date: "Sat, 24 Dec 2016")
Barcelone = Exchange.create!(title: 'Exchange Title', seller_id: jertrude.id, amount: 90, base_currency_id: eur.id, variable_currency_id: mnt.id, city: 'Barcelone', start_date: "Fri, 23 Dec 2016", end_date: "Sat, 24 Dec 2016")
Beijing = Exchange.create!(title: 'Exchange Title', seller_id: micheline.id, amount: 1000, base_currency_id: cny.id, variable_currency_id: usd.id, city: 'Beijing', start_date: "Wed, 28 Dec 2016", end_date: "Thu, 29 Dec 2016")
Montevideo = Exchange.create!(title: 'Exchange Title', seller_id: helena.id, amount: 1200, base_currency_id: uyu.id, variable_currency_id: eur.id, city: 'Montevideo', start_date: "Wed, 21 Dec 2016", end_date: "Thu, 22 Dec 2016")
LaPaz = Exchange.create!(title: 'Exchange Title', seller_id: cedric.id, amount: 120, base_currency_id: usd.id, variable_currency_id: bob.id, city: 'La paz', start_date: "Thu, 22 Dec 2016", end_date: "Fri, 23 Dec 2016")
...
Barcelone2 = Exchange.create!(title: 'Exchange Title', seller_id: margaux.id, amount: 50, base_currency_id: eur.id, variable_currency_id: cny.id, city: 'Barcelone', start_date: "Sun, 25 Dec 2016", end_date: "Mon, 26 Dec 2016")
Taiwan2 = Exchange.create!(title: 'Exchange Title', seller_id: aymeric.id, amount: 1500, base_currency_id: twd.id, variable_currency_id: hkd.id, city: 'Taïwan', start_date: "Wed, 28 Dec 2016", end_date: "Sat, 31 Dec 2016")
...
HongKong3 = Exchange.create!(title: 'Exchange Title', seller_id: hortense.id, amount: 300, base_currency_id: hkd.id, variable_currency_id: eur.id, city: 'Hong-Kong', start_date: "Thu, 29 Dec 2016", end_date: "Sat, 31 Dec 2016")
Madrid = Exchange.create!(title: 'Exchange Title', seller_id: margaux.id, amount: 40, base_currency_id: eur.id, variable_currency_id: zar.id, city: 'Madrid', start_date: "Fri, 08 Jan 2016", end_date: "Sun, 10 Jan 2016")
Lyon = Exchange.create!(title: 'Exchange Title', seller_id: pauline.id, amount: 1200, base_currency_id: vnd.id, variable_currency_id: eur.id, city: 'Lyon', start_date: "Thu, 22 Dec 2016", end_date: "Fri, 23 Dec 2016")
Paris = Exchange.create!(title: 'Exchange Title', seller_id: pauline.id, amount: 300, base_currency_id: rub.id, variable_currency_id: eur.id, city: 'Paris', start_date: "Wed, 28 Dec 2015", end_date: "Fri, 01 Jan 2016")
